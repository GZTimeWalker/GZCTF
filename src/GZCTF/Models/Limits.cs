...
public static class Limits
{
    ...
    /// <summary>
    /// Max length of DNS name or IP address
    /// </summary>
    public const int MaxHostLength = 255;

    /// <summary>
    /// Max length of container ID
    /// </summary>
    /// <remarks>
    /// For docker, the container ID is 64 hex characters;
    /// For kubernetes, the container ID is the pod name, generated by us;
    /// </remarks>
    public const int MaxContainerIdLength = 127;
}
