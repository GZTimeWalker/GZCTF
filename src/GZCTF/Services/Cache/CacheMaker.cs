    ...
    IServiceScopeFactory serviceScopeFactory) : IHostedService
{
    ...
    public Task StopAsync(CancellationToken token)
    {
        ...
        logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_Stopped)], TaskStatus.Success, LogLevel.Debug);
    ...
    {
        logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_WorkerStarted)], TaskStatus.Pending, LogLevel.Debug);
        ...
        try
        {
            await foreach (CacheRequest item in channelReader.ReadAllAsync(token))
            {
                ...
                {
                    logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_NoMatchingRequest), item.Key], TaskStatus.NotFound, LogLevel.Warning);
                    continue;
                }
                ...
                if (key is null)
                {
                    logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_InvalidUpdateRequest), item.Key], TaskStatus.NotFound, LogLevel.Warning);
                    continue;
                }
                ...
                if (await cache.GetAsync(updateLock, token) is not null)
                {
                    ...
                    logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_InvalidUpdateRequest), key], TaskStatus.Pending, LogLevel.Debug);
                    continue;
                }
                ...
                try
                {
                    ...
                    if (bytes is not null && bytes.Length > 0)
                    {
                        ...
                        logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_Updated), key, bytes.Length], TaskStatus.Success, LogLevel.Debug);
                    }
                    else
                    {
                        logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_GenerationFailed), key], TaskStatus.Failed, LogLevel.Warning);
                    }
                }
                catch (Exception e)
                {
                    logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_UpdateWorkerFailed), key, e.Message], TaskStatus.Failed, LogLevel.Error);
                }
                finally
                {
        ...
        {
            logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_WorkerCancelled)], TaskStatus.Exit, LogLevel.Debug);
        }
        finally
        {
            logger.SystemLog(Program.LocalizerForLogging[nameof(Resources.Program.Cache_WorkerStopped)], TaskStatus.Exit, LogLevel.Debug);
        }
    }
}