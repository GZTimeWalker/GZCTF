...
export const IconWiderScreenRequired: FC = () => {
  return (
    ...
    >
      <path id="arrowRodL2" className={classes.back} fillRule="evenodd" d="M1920,2900v600H640V2900H1920Z" />
      <path id="arrowRodL1" className={classes.front} fillRule="evenodd" d="M3200,2900v600H1920V2900H3200Z" />
      <path
        id="Triangle"
      ...
      />
      <path id="arrowRodR" className={classes.front} fillRule="evenodd" d="M3200,3500V2900H5760v600H3200Z" />
      <path
        id="arrowR"
