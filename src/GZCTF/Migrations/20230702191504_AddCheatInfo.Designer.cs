...
namespace CTFServer.Migrations
{
    ...
    [Migration("20230702191504_AddCheatInfo")]
    partial class AddCheatInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CTFServer.Models.Data.CheatInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CTFServer.Models.Data.CheatInfo", b =>
                {
                    ...
                    b.HasOne("CTFServer.Models.Participation", "SourceTeam")
                        .WithMany()
                        .HasForeignKey("SourceTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CTFServer.Models.Submission", "Submission")
                        .WithMany()
                        .HasForeignKey("SubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CTFServer.Models.Participation", "SubmitTeam")
                        .WithMany()
            ...
            modelBuilder.Entity("CTFServer.Models.Post", b =>
                {
                    b.HasOne("CTFServer.Models.UserInfo", "Author")
                        .WithMany()
