...
namespace GZCTF.Migrations.SQLServer
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSignedInUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastVisitedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    RegisterTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    Bio = table.Column<string>(type: "nvarchar(63)", maxLength: 63, nullable: false),
                    RealName = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    StdNumber = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    ExerciseVisible = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AvatarHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectStopAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicKey = table.Column<string>(type: "nvarchar(63)", maxLength: 63, nullable: false),
                    PrivateKey = table.Column<string>(type: "nvarchar(63)", maxLength: 63, nullable: false),
                    Hidden = table.Column<bool>(type: "bit", nullable: false),
                    PosterHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Summary = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AcceptWithoutReview = table.Column<bool>(type: "bit", nullable: false),
                    WriteupRequired = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    WriteupDeadline = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    WriteupNote = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BloodBonus = table.Column<long>(type: "bigint", nullable: false),
                    PracticeMode = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteIP = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bio = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    AvatarHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PublishTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagTemplate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AttachmentId = table.Column<int>(type: "int", nullable: true),
                    TestContainerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnableTrafficCapture = table.Column<bool>(type: "bit", nullable: false),
                    OriginalScore = table.Column<int>(type: "int", nullable: false),
                    MinScoreRate = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Answer = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SubmitTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    ParticipationId = table.Column<int>(type: "int", nullable: false),
                    GameId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SolveTimeUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    IsSolved = table.Column<bool>(type: "bit", nullable: false),
                    IsLoaded = table.Column<bool>(type: "bit", nullable: false),
                    LastContainerOperation = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[ExerciseInstanceId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[GameInstanceId] IS NOT NULL");
