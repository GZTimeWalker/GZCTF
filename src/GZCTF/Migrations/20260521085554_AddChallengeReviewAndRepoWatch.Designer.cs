...
namespace GZCTF.Migrations
{
    ...
    [Migration("20260521085554_AddChallengeReviewAndRepoWatch")]
    partial class AddChallengeReviewAndRepoWatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ContainerAccessEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("AccessingParticipationId")
                        .HasColumnType("integer");

                    b.Property<Guid?>("AccessingUserId")
                        .HasColumnType("uuid");

                    b.Property<string>("AccessingUserName")
                        .HasMaxLength(256)
                    ...
                    b.Property<int>("ContainerOwnerParticipationId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AccessingUserId", "ChallengeId");

                    b.HasIndex("ChallengeId", "ConnectedAtUtc");

                    b.HasIndex("GameId", "ConnectedAtUtc");

                    b.ToTable("ContainerAccessEvents");
                });
            ...
            modelBuilder.Entity("GZCTF.Models.Data.EventManager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.FlagEgressEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GameId", "LastSeenUtc");

                    b.ToTable("FlagEgressEvents");
                });
            ...
            modelBuilder.Entity("GZCTF.Models.Data.SuspicionEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RelatedParticipationId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RelatedParticipationId");

                    b.ToTable("SuspicionEvents");
                });

            modelBuilder.Entity("GZCTF.Models.Data.SuspicionRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.SuspicionEvent", b =>
                {
                    ...
                    b.HasOne("GZCTF.Models.Data.Participation", "Participation")
                        .WithMany("SuspicionEvents")
                        .HasForeignKey("ParticipationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GZCTF.Models.Data.Participation", "RelatedParticipation")
                        .WithMany()
                        .HasForeignKey("RelatedParticipationId");

                    b.Navigation("Game");

                    b.Navigation("Participation");

                    b.Navigation("RelatedParticipation");
                });
