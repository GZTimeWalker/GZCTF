...
public class GameRepositoryTests(GZCTFApplicationFactory factory, ITestOutputHelper output)
{
    ...
    public async Task GenRecentGames_ShouldOrderCorrectly()
    {
        ...
        output.WriteLine($"Recent games ordering test passed - Ongoing: {ongoingIndex}, Upcoming: {upcomingIndex}, Ended: {endedIndex}");
    }
    ...
    public async Task GetCheckInfo_ShouldReturnJoinedTeamsAndDivisions()
    {
        ...
        // Create divisions
        var division1 = await divisionRepo.CreateDivision(game, new Models.Request.Edit.DivisionCreateModel
        {
            Name = "Division 1",
            InviteCode = "DIV1",
        ...
        var division2 = await divisionRepo.CreateDivision(game, new Models.Request.Edit.DivisionCreateModel
        {
            Name = "Division 2",
            InviteCode = "DIV2",
        ...
        await divisionRepo.CreateDivision(game, new Models.Request.Edit.DivisionCreateModel
        {
            Name = "Division 3",
            InviteCode = "DIV3",
        ...
        output.WriteLine($"Check info test passed - Joined teams: {checkInfo.JoinedTeams.Length}, Joinable divisions: {checkInfo.JoinableDivisions.Length}");
    }
