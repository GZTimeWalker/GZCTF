...
The Jeopardy mode itself is already capable of training, and fixing/patching can be achieved through direct teaching and distributing local experiment images. The original intention of GZCTF is to **help universities better train their CTF teams**, rather than hosting formal competitions. From an educational perspective, the necessity of building an AWD platform is very low. If you want to train AWD/AWD skills, it is better to participate in an onsite competition, which is another aspect to consider.
