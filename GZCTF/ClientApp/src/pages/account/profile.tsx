...
import { Box, Stack, Group, Divider, Title, Text, Button, Input, Grid, Card, TextInput, Paper, Center, Textarea, Modal, PasswordInput, Avatar, Image, Indicator } from '@mantine/core';
...
const Profile: NextPage = () => {
  ...
  */
  ...
  <>
    ...
    <WithNavBar>
      <Stack align="center">
        <Paper style={{ width: "55%", padding: "5%", paddingTop: "2%", marginTop: "5%" }} shadow = "sm" p="lg" >
          {/* Header */}
