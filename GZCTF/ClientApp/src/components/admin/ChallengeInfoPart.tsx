...
import api, { ChallengeTag, ChallengeType } from '../../Api'
import {
  ChallengeTypeItem,
  ChallengeTypeLabelMap,
  ChallengeTagItem,
  ChallengeTagLabelMap,
  ChallengeEditPartProps,
  ChallengeAccordionControl,
} from '../ChallengeItem'
import ScoreFunc from './ScoreFunc'

const ChallengeInfoPart: FC<ChallengeEditPartProps> = (props) => {
      ...
      <ChallengeAccordionControl
        ...
        onBtnClick={() =>
          onUpdate({
            ...
            originalScore: challengeInfo.originalScore,
