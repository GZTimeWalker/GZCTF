...
RUN dotnet publish "CTFServer.csproj" -c Release -o /app/publish -r linux-x64 --no-restore /p:PublishReadyToRun=true /p:PublishReadyToRunComposite=true /p:PublishTrimmed=true /p:TrimMode=CopyUsed
